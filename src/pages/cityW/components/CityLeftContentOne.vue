    ...
    <div class="leftContentOne">
        <!--第一部分-->
            ...
            <div class="weatherData">
                <div class="onDayWeather"  v-for="(item, index) of weatherList" :key="index" :class="{active: isIndex==index}">
...
export default {
    ...
    data(){
        return{
            ...
            isIndex: 0,
            tiaozhuan: '',
            weatherList:[{Date:'2日',Img:'&#xe627;',Du:'18-19℃',Rain: '阵雨',Wind: '东北风', Level:'优'},
                    {Date:'3日',Img:'&#xe621;',Du:'18-19℃',Rain: '晴',Wind: '东北风', Level:'优'},
                    {Date:'4日',Img:'&#xe627;',Du:'18-19℃',Rain: '小雨',Wind: '东北风', Level:'优'},
                    {Date:'5日',Img:'&#xe627;',Du:'18-19℃',Rain: '多云',Wind: '东北风', Level:'优'},
                    {Date:'6日',Img:'&#xe627;',Du:'18-19℃',Rain: '晴',Wind: '东北风', Level:'优'}]
        }
