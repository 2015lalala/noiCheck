<template>
    <div class="commonHeader">
        <div class="leftContent">
            <div class="backBtn">
                <router-link :to="'/city/'  + this.$store.state.headerCity">
                    <span class="iconfont backBtnA">&#xe602;</span>
                </router-link>
...
export default {
    ...
    data(){
        return{
            proNameTitle: '浙江省负氧离子服务平台'
        }
    },
    methods: {
       changeToCheck(){
           this.$router.push('/stationW/' + this.$store.state.headerStation)
       }
    }
