<template>
    <div class="commonHeader">
        <div class="leftContent">
            <div class="backBtn">
                <router-link :to='"/cityW/"  + this.$store.state.headerCity'>
                    <span class="backBtnA"></span>
                </router-link>
                <span class="iconfont cityIcon">&#xe68d;</span>
                <span class="pageName">{{this.$store.state.headerStation}}</span>
            </div>
            <div class="twoLevelTitle">
                <div class="twoLevelTitleName lf">
                    ...
                    <span class="lf" style="margin-left:10px">站点评价</span>
                </div>
                <div class="zhishu lf">
                    <div>
                        <span class="iconfont">&#xe601;</span>
                    </div>
                    <div @click="changeToCheck">负氧离子</div>
                </div>
            </div>
        </div>
...
export default {
    ...
    data(){
        return{
            proNameTitle: '浙江省气候指数服务平台'
        }
    },
    methods: {
       changeToCheck(){
           this.$router.push('/station/' + this.$store.state.headerStation)
       }
    }
        ...
        .leftContent
            ...
            .backBtn
                ...
                .backBtnA
                    ...
                    text-align : center
                    background : #3A536E
                    background: url('/qian.png') no-repeat
